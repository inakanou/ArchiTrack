...
/**
 * @requirement estimate-creation/REQ-51.1 表紙に「御見積書」の表題を網掛けの枠内に出力する
 */
...
/**
 * @requirement estimate-creation/REQ-51.2 表紙に見積書の提出日を出力する
 * @requirement estimate-creation/REQ-51.3 表紙の宛先としてプロジェクトの取引先名を出力する
 * @requirement estimate-creation/REQ-51.4 取引先に代表者名が登録されている場合は敬称とともに出力する
 * @requirement estimate-creation/REQ-51.5 表紙にリード文「下記のとおり御見積申し上げます。」を出力する
 * @requirement estimate-creation/REQ-53.9 表紙の提出日を全角数字で出力する
 */
...
/**
 * @requirement estimate-creation/REQ-51.6 表紙に見積金額を他の項目より大きな文字で出力する
 * @requirement estimate-creation/REQ-51.7 表紙に消費税を含まない旨の注記を出力する
 * @requirement estimate-creation/REQ-51.8 表紙に見積の有効期限を出力する
 * @requirement estimate-creation/REQ-53.8 表紙の見積金額を全角数字と全角カンマで出力する
 */
...
/**
 * @requirement estimate-creation/REQ-51.9 表紙の工事件名としてプロジェクト名を出力する
 * @requirement estimate-creation/REQ-51.10 表紙の工事場所としてプロジェクトの現場住所を出力する
 */
...
/**
 * @requirement estimate-creation/REQ-51.12 表紙の右側に自社情報として会社名・代表者・住所・電話番号・FAX番号を出力する
 * @requirement estimate-creation/REQ-51.14 自社情報の郵便番号を独立した行として出力しない
 */
...
/**
 * @requirement estimate-creation/REQ-51.15 取引先または現場住所が未登録の場合も該当欄を空欄として出力し処理を継続する
 */
