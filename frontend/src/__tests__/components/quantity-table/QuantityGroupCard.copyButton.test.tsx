 ...
 *
 * Requirements:
 * @requirement quantity-table-generation/REQ-38.1 各数量グループパネルの表題部にコピーボタンを表示する
 * @requirement quantity-table-generation/REQ-38.9 コピー処理中はインジケーターを表示し、重複押下を防止する
 * @requirement quantity-table-generation/REQ-38.12 既存の表題部要素（グループ名、写真サムネイル、折りたたみボタン、削除ボタン等）と視覚的に干渉しないレイアウトで配置する
 *
