/**
 * @fileoverview TradingPartnerPaginationUI コンポーネント テスト
 *
...
describe('TradingPartnerPaginationUI', () => {
  ...
  describe('ページ情報表示（trading-partner-management/REQ-1.5）', () => {
    it('現在のページ番号が表示される', () => {
      render(
        <TradingPartnerPaginationUI
          pagination={defaultPagination}
  ...
  describe('ページ遷移（trading-partner-management/REQ-1.5）', () => {
  ...
  describe('表示件数変更（trading-partner-management/REQ-1.5）', () => {
