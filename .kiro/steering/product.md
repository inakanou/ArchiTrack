...
_最終更新: 2026-04-27（Steering Sync: 現場調査の注釈モバイル操作性強化（REQ24-30）と画像プレビュー全体表示対応を反映）_
