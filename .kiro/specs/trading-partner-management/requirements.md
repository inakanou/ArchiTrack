...
11. If 同一の取引先名および部課/支店/支社名の組み合わせが既に存在する場合, then the 取引先管理サービス shall 「この取引先名と部課/支店/支社名の組み合わせは既に登録されています」というエラーを表示する
...
8. If 別の取引先と重複する取引先名および部課/支店/支社名の組み合わせに変更しようとした場合, then the 取引先管理サービス shall 「この取引先名と部課/支店/支社名の組み合わせは既に登録されています」というエラーを表示する
