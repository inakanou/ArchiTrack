...
### Requirement 11: 見積書登録機能

**Objective:** As a ユーザー, I want 見積依頼に対する返答として届いた見積書を登録したい, so that 複数の見積書を一元管理し、比較検討できる

#### Acceptance Criteria

1. The システム shall 見積依頼詳細画面に「見積書登録」ボタンを表示する
2. When ユーザーが「見積書登録」ボタンをクリックしたとき, the システム shall 見積書登録フォームを表示する
3. The システム shall 見積書登録フォームに見積書名入力フィールドを表示する
4. The システム shall 見積書登録フォームに提出日入力フィールドを表示する
5. The システム shall 見積書登録フォームにテキスト入力フィールドを表示する
6. The システム shall 見積書登録フォームにファイルアップロードフィールドを表示する
7. The システム shall テキスト入力とファイルアップロードの排他的選択を提供する
8. The システム shall アップロード可能なファイル形式としてPDF、Excel（.xlsx、.xls）、画像（.jpg、.jpeg、.png）を許可する
9. When ユーザーが見積書名、提出日、および内容（テキストまたはファイル）を入力して保存したとき, the システム shall 見積書を登録する
10. If 必須項目（見積書名、提出日、内容）が未入力の場合, then the システム shall バリデーションエラーを表示する
11. The システム shall 1つの見積依頼に対して複数の見積書の登録を許可する
12. The システム shall 見積依頼詳細画面に登録済み見積書の一覧を表示する
13. The システム shall 見積書一覧に見積書名、提出日、登録日時を表示する
14. When ユーザーがアップロードされたファイルをクリックしたとき, the システム shall ブラウザでファイルをプレビュー表示する
15. The システム shall 見積書の編集機能を提供する
16. The システム shall 見積書の削除機能を提供する
17. When ユーザーが見積書を削除しようとしたとき, the システム shall 削除確認ダイアログを表示する
