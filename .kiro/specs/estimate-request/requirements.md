...
10. The システム shall 構造化データ入力エリアに以下のフィールドを持つ明細行を表示する: 名称、規格、単位、数量、単価、金額、備考
...
11. When ユーザーが一括取り込みボタンをクリックしたとき, the システム shall 抽出結果を解析し、名称・規格・単位・数量・単価を各明細行のフィールドに自動入力する
...
2. The システム shall 受領見積書の明細行データ（名称、規格、単位、数量、単価、金額、備考）をデータベースに永続化する
