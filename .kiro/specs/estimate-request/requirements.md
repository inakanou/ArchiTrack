...
5. When 見積依頼のステータスが「依頼前」のとき, the システム shall 「依頼済」への遷移ボタンを表示する
6. When 見積依頼のステータスが「依頼済」のとき, the システム shall 「見積受領済」への遷移ボタンを表示する
7. When 見積依頼のステータスが「依頼済」のとき, the システム shall 「依頼前」への遷移ボタンを非表示にする
8. When 見積依頼のステータスが「見積受領済」のとき, the システム shall 「依頼済」への遷移ボタンを表示する
