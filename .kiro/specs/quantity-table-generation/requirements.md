...
### 機能概要
数量表は複数の「数量グループ」で構成され、各数量グループには現場調査写真を紐づけることができます。数量グループ内には複数の「数量項目」を追加でき、各項目は大項目・中項目・小項目・任意分類・工種・名称・規格・単位・計算方法・（計算用列）・調整係数・丸め設定・数量・備考の属性を持ちます。
