...
- [ ] 1. データベーススキーマと基盤サービスの実装
- [ ] 1.1 (P) 数量表、数量グループ、数量項目のデータモデルを作成する
...
- [ ] 3.4 (P) オートコンプリートAPIエンドポイントを実装する
  - 列別の入力候補取得API
  - プロジェクト内の保存済み値の集約
  - 重複除去と50音順ソート
  - 最大100件制限
...
- [ ] 4. フロントエンド基盤コンポーネントの実装
- [ ] 4.1 プロジェクト詳細画面の数量表セクションを実装する
  - 数量表セクションカードの表示
  - 総数とヘッダー情報の表示
