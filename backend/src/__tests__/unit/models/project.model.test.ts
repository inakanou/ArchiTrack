 ...
 * - REQ-1.14: プロジェクトに一意のIDを自動付与
 * - REQ-1.15: 作成日時と作成者を自動的に記録
 * - REQ-9.7: 削除されたプロジェクトは一覧に表示しない（論理削除）
 * - REQ-13.1: プロジェクト名を必須かつ1〜255文字
 * - REQ-13.2: 顧客名を必須かつ1〜255文字
 * - REQ-13.3: 営業担当者を必須
 * - REQ-13.5: 工事担当者を任意
 * - REQ-13.7: 現場住所を任意かつ最大500文字
 * - REQ-13.8: 概要を任意かつ最大5000文字
 */
