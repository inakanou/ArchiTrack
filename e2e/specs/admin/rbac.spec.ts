 ...
 * @REQ-17.4 システム管理者がロール一覧を取得
 * @REQ-18.3 システム管理者が権限一覧を取得
 * @REQ-18.4 ワイルドカード権限のサポート
...
test.describe('ロールベースアクセス制御（RBAC）', () => {
   ...
   * 要件6.2: 権限不足時の403エラー
   * @REQ-6.1 @REQ-6.2
   * @REQ-21.8 ロール・権限変更時のキャッシュ無効化
   * @REQ-21.9 権限情報のキャッシュ機構
   ...
   * @REQ-21.1 @REQ-21.2
   * @REQ-21.3 全ロールから権限を収集
   * @REQ-21.6 所有者フィルタリングの適用
   * @REQ-21.7 権限チェック失敗を監査ログに記録
   * @REQ-21.10 権限チェック時のパラメータ（ユーザーID、リソースタイプ等）
   */
